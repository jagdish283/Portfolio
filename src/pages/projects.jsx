...
import logotraffic from '@/images/logos/traffic.svg';
...
const projects = [
  ...
  {
    name: 'Bangalore-Traffic-Analysis',
    description:
      'Bangalore Traffic Dashboard built using Power BI to analyze traffic volume, congestion, environmental impact across Bangalore.',
    link: {
      href: 'https://github.com/jagdish283/Bangalore-Traffic-Analysis',
      label: 'Github',
    },
    logo: logotraffic,
  },
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Jagdish Sutar</title>
        <meta
          name="description"
