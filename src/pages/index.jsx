...
export default function Home({ blogs }) {
 ...
 <Image style={{display: "inline", width: "20px"}} src={WinkImage} alt="wink"/> I am proficient in GCP, Power BI, Github Copilot and hold Certifications.
                    </p>
